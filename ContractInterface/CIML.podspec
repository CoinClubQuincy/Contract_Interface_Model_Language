#
#  Be sure to run `pod spec lint CIML.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "CIML"

  spec.homepage     = "http://EXAMPLE/CIML"
  ...
  # Or just: spec.author    = "Quincy Jones"
  # spec.authors            = { "Quincy Jones" => "rqjones@asu.edu" }
  # spec.social_media_url   = "https://twitter.com/Quincy Jones"
  ...
  spec.source       = { :git => "https://github.com/CoinClubQuincy/Contract_Interface_Model_Language", :tag => "#{spec.version}" }
